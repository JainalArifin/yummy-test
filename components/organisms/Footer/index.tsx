          ...
          <div className="row">
            <div className="col-lg-4 text-lg-start text-center">
              ...
              <p className="mt-30 text-lg color-palette-1 mb-30">
                ...
                <br />
                {' '}
                untuk membangun Aplikasi yang anda inginkan
              </p>
            </div>
              ...
              <div className="row gap-sm-0">
                ...
                <div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-6">
                      <a
                        href="mailto: lusyjainal@gmail.com"
                        className="text-lg color-palette-1 text-decoration-none"
                      >
                        lusyjainal@gmail.com
                      </a>
                    </li>
                   
                    <li className="mb-6">
                      <a
                        href="https://www.google.com/maps/place/Bulakamba,+Grinting,+Kec.+Bulakamba,+Kabupaten+Brebes,+Jawa+Tengah/@-6.8682001,108.894182,14z/data=!3m1!4b1!4m5!3m4!1s0x2e6faf67a213bc49:0x7d6af7ec4ca829f4!8m2!3d-6.868244!4d108.928001"
                        className="text-lg color-palette-1 text-decoration-none"
                        target="_blank"
                      >
                        Bulakamba
